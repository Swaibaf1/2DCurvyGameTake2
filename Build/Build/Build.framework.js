...
var ASM_CONSTS = {
  4746368: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4746423: ($0) => { performance.now = function() { return $0; }; },  
 4746471: ($0) => { performance.now = function() { return $0; }; },  
 4746519: () => { performance.now = Module['emscripten_get_now_backup']; }
};
